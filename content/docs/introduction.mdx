...
It works with developer, art, crypto, course, membership, and general-interest communities. You can also add the [chat widget](/docs/product/widget) to any website or documentation site that supports custom JavaScript.
